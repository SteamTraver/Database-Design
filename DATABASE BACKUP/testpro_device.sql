...
CREATE TABLE `device` (
  ...
  KEY `anju_user_id_to_device_idx` (`anju_user_id`),
  CONSTRAINT `anju_user_id_to_device` FOREIGN KEY (`anju_user_id`) REFERENCES `anju_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
