...
CREATE TABLE `terminal` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='用户终端表。记录用户所用的终端。与用户是多对多的关系。所以存在中间表：user_has_terminal。';
...
INSERT INTO `terminal` VALUES (24,'GM1900','48:01:C5:17:B4:69','192.168.137.93','18279430199','Y'),(26,'GM1900','48:01:C5:17:B4:69','192.168.137.34','18279430191','Y'),(29,'PCGM00','C0:2E:25:D9:CE:23','192.168.137.185','15107949156','N'),(30,'PCGM00','C0:2E:25:D9:CE:23','192.168.137.185','18379457511','N'),(31,'MI 9','A8:9C:ED:B6:AE:9A','192.168.137.117','15107949156','N'),(32,'MI 9','A8:9C:ED:B6:AE:9A','192.168.137.117','18379457511','Y'),(33,'PCGM00','C0:2E:25:D9:CE:23','192.168.137.185','18379457511','N');
