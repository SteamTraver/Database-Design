...
CREATE TABLE `video_thumb` (
  ...
  KEY `video_id_to_video_thumb1_idx` (`video_id`,`video_user_id`,`video_anju_user_id`),
  CONSTRAINT `video_id_to_video_thumb1` FOREIGN KEY (`video_id`, `video_user_id`, `video_anju_user_id`) REFERENCES `video` (`id`, `user_id`, `anju_user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-09-09 16:34:12
