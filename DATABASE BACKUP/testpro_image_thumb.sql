...
CREATE TABLE `image_thumb` (
  ...
  KEY `friend_id_to_image_thumb1_idx` (`friend_id`),
  CONSTRAINT `friend_id_to_image_thumb1` FOREIGN KEY (`friend_id`) REFERENCES `friend` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
