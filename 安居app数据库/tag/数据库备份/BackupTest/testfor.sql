...
-- Dump completed on 2019-09-10 15:07:10
-- MySQL dump 10.13  Distrib 8.0.17, for Win64 (x86_64)
--
...
CREATE TABLE `anju_user` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `phone_UNIQUE` (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='用户表。数据库核心表。记录用户的相关各种信息。部分用户可以选填，部分必须填。具体看字段注释。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `anju_user` WRITE;
/*!40000 ALTER TABLE `anju_user` DISABLE KEYS */;
INSERT INTO `anju_user` VALUES (16,'dTp63TJ','123456','18279430191',NULL,'2019-09-09 17:39:31','2019-09-09 17:39:31','未知','1990-01-01','家用 室内'),(18,'Sppp','123456','15107949156',NULL,'2019-09-10 11:31:33','2019-09-10 11:31:43','男','1990-01-01','家用 室内');
/*!40000 ALTER TABLE `anju_user` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
CREATE TABLE `operationlog` (
  ...
  CONSTRAINT `anju_user_id_to_operationlog1` FOREIGN KEY (`anju_user_id`) REFERENCES `anju_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `terminal_id_to_operationlog1` FOREIGN KEY (`terminal_id`) REFERENCES `terminal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=182 DEFAULT CHARSET=utf8 COMMENT='操作日志表。表中字段tinytext记录具体的用户操作。tinytext的内容由程序自动生成，记录用户的关键操作。例如登录、注销、解除设备绑定等等。随着时间的推移。此表的大小会越来越大。所以应该对每个用户设定查看日期，只存储N日的操作日志。具体方式还没定下来。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `operationlog` WRITE;
/*!40000 ALTER TABLE `operationlog` DISABLE KEYS */;
INSERT INTO `operationlog` VALUES (152,'退出账号','2019-09-09 17:39:47','2019-09-09 17:39:47',43,16),(154,'登录账号','2019-09-09 17:45:25','2019-09-09 17:45:25',43,16),(161,'登录账号','2019-09-09 18:21:43','2019-09-09 18:21:43',43,16),(162,'登录账号','2019-09-09 18:21:43','2019-09-09 18:21:43',55,16),(164,'退出账号','2019-09-09 18:21:57','2019-09-09 18:21:57',43,16),(165,'退出账号','2019-09-09 18:21:57','2019-09-09 18:21:57',55,16),(167,'登录账号','2019-09-09 18:22:09','2019-09-09 18:22:09',55,16),(168,'退出账号','2019-09-09 18:22:20','2019-09-09 18:22:20',55,16),(169,'登录账号','2019-09-09 18:23:44','2019-09-09 18:23:44',56,16),(170,'退出账号','2019-09-09 18:23:51','2019-09-09 18:23:51',56,16),(171,'登录账号','2019-09-09 18:24:11','2019-09-09 18:24:11',55,16),(180,'退出账号','2019-09-10 11:42:17','2019-09-10 11:42:17',59,18);
/*!40000 ALTER TABLE `operationlog` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `terminal` (
  ...
  `using` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'Y' COMMENT '标志当前终端是否被使用。值有两种“Y”与“N”',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='用户终端表。记录用户所用的终端。与用户是多对多的关系。所以存在中间表：user_has_terminal。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `terminal` WRITE;
/*!40000 ALTER TABLE `terminal` DISABLE KEYS */;
INSERT INTO `terminal` VALUES (43,'GM1900','48:01:C5:17:B4:69','192.168.137.11','18279430191','N'),(55,'PCGM00','C0:2E:25:D9:CE:23','192.168.137.185','18279430191','Y'),(56,'MI 9','A8:9C:ED:B6:AE:9A','192.168.137.236','18279430191','N'),(59,'PCGM00','C0:2E:25:D9:CE:23','192.168.137.185','15107949156','N');
/*!40000 ALTER TABLE `terminal` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
CREATE TABLE `user_has_terminal` (
  ...
  CONSTRAINT `anju_user_id_to_user_has_terminal1` FOREIGN KEY (`anju_user_id`) REFERENCES `anju_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `terminal_id_to_user_has_terminal1` FOREIGN KEY (`terminal_id`) REFERENCES `terminal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8 COMMENT='作为user表和terminal表的中间表。便于查询。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `user_has_terminal` WRITE;
/*!40000 ALTER TABLE `user_has_terminal` DISABLE KEYS */;
INSERT INTO `user_has_terminal` VALUES (120,'2019-09-09 18:21:42','2019-09-09 18:21:42','已绑定',16,55),(124,'2019-09-10 11:31:33','2019-09-10 11:31:33','已绑定',18,59);
/*!40000 ALTER TABLE `user_has_terminal` ENABLE KEYS */;
UNLOCK TABLES;
